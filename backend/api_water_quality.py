...
DO_PARAMS = {
    ...
    # Engineering saturation traceability generated by the Benson-Krause/USGS calculation.
    "DO_SATURATION_MG_L": {"unit_default": "mg/L", "min": 0.0, "max": 20.0},
    "DO_SATURATION_VENDOR": {"unit_default": "%", "min": 0.0, "max": 200.0},
    "DO_SATURATION_PRESSURE_KPA": {"unit_default": "kPa", "min": 51.0, "max": 112.0},
    "DO_SATURATION_SALINITY_PPT": {"unit_default": "‰", "min": 0.0, "max": 40.0},
}
